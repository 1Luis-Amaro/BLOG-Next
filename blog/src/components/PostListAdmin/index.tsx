      ...
      >
        ...
        >
          ...
          <p>
            ...
            dolores repellendus illum laboriosam? Debitis vero culpa sequi hic
            amet impedit quasi voluptates laudantium pariatur quaerat! Ipsa
            sapiente accusamus nam tempora?
          </p>
          <div className="flex items-center justify-around">
            ...
            <button
              className={clsx(
                "bg-blue-300 hover:bg-blue-600 transition text-blue-50 ",
                "flex items-center justify-center",
                "py-2 px-4 rounded-lg cursor-pointer"
              )}
            >
